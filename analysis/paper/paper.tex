...
\hypersetup{
  ...
  pdfauthor={Carl Boettiger; Bob Security; Cat Memes; Derek Zoolander},
...
complexities\citep{Bartlett1960, Levins1966}.
...
transitions of any sort, not just step sizes of \(+/- 1\) and not just
birth and death events, but can include transitions between stage
classes or trait values, including mutations to continuously-valued
traits in evolutionary dynamics (e.g.~Boettiger et al.~2010).
...
\pandocbounded{\includegraphics[keepaspectratio]{paper_files/figure-pdf/unnamed-chunk-1-1.pdf}}

\textbf{?@fig-site-simulation} shows the results of two exact SSA
